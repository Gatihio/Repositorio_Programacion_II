...
nombre_marcado = tk.Label(marco, text="Contador Decreciente", bg="lightblue", font=("Arial", 14, "bold"))
nombre_marcado.pack(pady=(0, 10))

# Crear un botón con el símbolo + y una acción
boton_mas = tk.Button(marco, text="-", font=("Arial", 24), width=5, height=2, command=disminuir_contador)
